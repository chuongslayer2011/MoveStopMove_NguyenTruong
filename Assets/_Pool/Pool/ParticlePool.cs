...
public static class ParticlePool
{
    ...
    class Pool
    {
        ...
        public void Play(Vector3 pos, Quaternion rot, Transform parent)
        {
    ...
    static public void Play(ParticleSystem prefab, Vector3 pos, Quaternion rot,  Transform parent)
    {
#if UNITY_EDITOR
        if (prefab == null)
        {
        ...
        pools[prefab.GetInstanceID()].Play(pos, rot,parent);
    }

    static public void Play(ParticleType particleType, Vector3 pos, Quaternion rot, Transform parent)
    {
#if UNITY_EDITOR
        ...
        Play(shortcuts[particleType], pos, rot, parent);
    }
